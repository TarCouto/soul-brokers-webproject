export function CorouselImage() {
  return (
    <div className="relative flex items-center justify-center  dark:text-gray-900">
      <button
      ...
      <div className="flex items-center justify-start w-full h-full gap-6 py-4 mx-auto overflow-auto lg:gap-8">
        <div className="relative flex flex-shrink-0 w-full min-w-[933px] min-h-[583px] sm:w-auto bg-emerald-200">
          <img
        ...
        <div className="relative flex flex-shrink-0 w-full sm:w-auto bg-emerald-200 min-w-[933px] min-h-[583px] ">
          <img
            className="object-cover object-center dark:bg-gray-500 h-96 aspect-square"
